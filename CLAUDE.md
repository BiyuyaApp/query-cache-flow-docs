# CLAUDE.md - CACHE-FLOW Documentation Project

## Project Overview

This project builds documentation for **CACHE-FLOW**, a TanStack Query cache key management framework. The documentation consists of:
...
CACHE-FLOW is a pattern/framework for managing TanStack Query cache keys in React applications. The core philosophy:
...
The actual CACHE-FLOW implementation lives in:
```
